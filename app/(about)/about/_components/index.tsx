...
import { Cloud, OrthographicCamera, Sky, Text } from "@react-three/drei";
...
const MailBox = dynamic(() => import("./Mailbox").then(
  (mod) => mod.MailBox as any
), {
  ssr: false,
  loading: () => <Loading3D/>
}) as any;

const GrassPlane = dynamic(() => import("./GlassPlane").then(
  (mod) => mod.GrassPlane as any
), {
  ssr: false,
  loading: () => <Loading3D/>
}) as any;
