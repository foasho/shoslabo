  ...
  const cards = [
    {
      ...
      route: "https://jp.pinterest.com/pin/677369600228748109/",
      tags: ["油絵", "動物", "Art"],
    },
    {
      key: "card-2",
  ...
  return (
    <div className='fixed left-0 top-0 z-10 h-screen w-screen overflow-y-auto'>
      ...
      <div className='container mx-auto px-4 py-8 pt-24 text-gray-800'>
        {/** タイトル */}
        <div className='mb-8 text-4xl font-bold'>Arts / Designs</div>
        {/** サブタイトル */}
        ...
        {/** 作成リンク */}
        <div className='mb-4'>
          <Link className='text-4xl text-red-500' href='https://jp.pinterest.com/sakasho0111/_created/' target='_blank'>
            <FaPinterest className='mr-2 inline-block' />
          </Link>
        </div>
        {/** カードリスト */}
