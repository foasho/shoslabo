...
export const HomeScene = () => {
  ...
  return (
    // @ts-ignore
    <View className={"h-full w-full bg-[#BA2636]"}>
      <Suspense fallback={<Loading3D color='#FFF' scale={3} />}>
        <Center>
...
const Avatar = () => {
  ...
  return (
    <group ref={ref} position={[0.17, -1.45, 0]} scale={0.01} rotation={[0, -Math.PI / 2, 0]}>
  ...
  return (
    <group scale={1.5} dispose={null}>
      ...
      <group position={[-0.691, -0.735, 0.694]} rotation={[-Math.PI / 2, 0, 0]} scale={0.001}>
        <group scale={42.327}>
          <mesh
            geometry={nodes.stem__0.geometry}
            material={materials["Scene_-_Root"]}
            position={[0, -0.359, 0.299]}
            castShadow
          />
        </group>
      </group>
      <mesh
        geometry={nodes.土.geometry}
        material={materials.マテリアル}
        position={[-0.684, -0.748, 0.71]}
        scale={[-0.164, -0.13, -0.164]}
      />
      <mesh
        geometry={nodes.植木鉢.geometry}
        material={materials["Black rubber"]}
        position={[-0.684, -0.813, 0.71]}
        scale={[-0.164, -0.13, -0.164]}
        castShadow
      />
      ...
      <mesh
        geometry={nodes.天板.geometry}
        material={materials.グレー}
        position={[-0.35, -0.479, 0.032]}
        receiveShadow
        castShadow
      />
      <mesh geometry={nodes.椅子の足.geometry} material={materials["Black rubber"]} position={[-0.35, -0.479, 0.032]} />
      <mesh
        geometry={nodes.くるくる.geometry}
        material={materials["Black rubber"]}
        position={[-0.512, -0.929, 0.355]}
        scale={0.023}
      />
      <mesh
        geometry={nodes.時計.geometry}
        material={materials.Blackリニア}
        position={[-0.993, 0.587, 0.542]}
        rotation={[0, 0, -Math.PI / 2]}
        scale={[-0.226, -0.017, -0.227]}
      />
      <mesh geometry={nodes.部屋001.geometry} material={materials["マテリアル.007"]} position={[0.001, 0, 0.001]} />

      {/** Canvas */}
      <mesh
        geometry={nodes.中心.geometry}
        material={materials.木目}
        position={[0.73, -0.591, -0.597]}
        rotation={[-0.241, -0.359, -0.086]}
        scale={[1, 1, 0.326]}
      />
      <mesh
        geometry={nodes.左右.geometry}
        material={materials.木目}
        position={[0.592, -0.591, -0.65]}
        rotation={[-0.237, -0.333, -0.197]}
        scale={[1, 1, 0.326]}
      />
      <mesh
        geometry={nodes.支え.geometry}
        material={materials.木目}
        position={[0.716, -0.675, -0.562]}
        rotation={[-0.16, -0.366, 1.513]}
        scale={[1, 0.652, 0.326]}
      />
      <mesh
        geometry={nodes.後ろ支え.geometry}
        material={materials.木目}
        position={[0.768, -0.72, -0.695]}
        rotation={[0.355, -0.445, 0.123]}
        scale={[0.999, 0.643, 0.315]}
      />
      {hovered === "canvas" && (
        <Annotation position={[0.75, -0.3, -0.606]} scale={0.25}>
          趣味や作品
        </Annotation>
      )}
      <mesh
      ...
      <mesh
        geometry={nodes.椅子マット.geometry}
        material={materials.椅子緑}
        position={[0.6, -0.731, -0.265]}
        rotation={[0, -0.395, 0]}
        scale={[0.115, 0.03, 0.115]}
      />
      <mesh
        geometry={nodes.椅子足001.geometry}
        material={materials.木目}
        position={[0.645, -0.842, -0.154]}
        rotation={[0, -0.395, 0]}
        scale={[0.024, 0.106, 0.025]}
      />
      ...
      ></mesh>
      <mesh
        geometry={nodes.アーム2.geometry}
        material={materials["Black rubber"]}
        position={[-0.555, -0.322, 0.032]}
        rotation={[0, -0.036, 0]}
        scale={0.019}
      />
      <mesh
        geometry={nodes.アーム3.geometry}
        material={materials["Black rubber"]}
        position={[-0.594, -0.322, 0.323]}
        scale={0.019}
      />
      <mesh
        geometry={nodes.マウス置き.geometry}
        material={materials["Black rubber"]}
        position={[-0.316, -0.479, -0.191]}
        rotation={[0, -1.571, 0]}
        scale={[-0.074, -0.093, -0.085]}
      />
      {/** 椅子 */}
      ...
      <mesh
        geometry={nodes.椅子足.geometry}
        material={materials.Blackリニア}
        position={[0.089, -0.873, 0.122]}
        rotation={[-0.891, 0, 0]}
        scale={1.15}
        castShadow
      />
      <mesh
        geometry={nodes.椅子足2.geometry}
        material={materials.Blackリニア}
        position={[-0.008, -0.873, 0.021]}
      ...
      <mesh
        ...
        material={materials["Black rubber"]}
        position={[-0.992, -0.346, 0.529]}
        rotation={[0, 0, -Math.PI / 2]}
        scale={[0.615, 0.615, 0.404]}
      />
    </group>
  );
};
...
const Annotation = ({ position, rotation = [0, 0, 0], scale = [1, 1, 1], children }: AnnotationProps) => {
...
function Lightformers({ positions = [2, 0, 2, 0, 2, 0, 2, 0] }) {
  ...
  useFrame(
    (state, delta) =>
      group.current && (group.current.position.z += delta * 10) > 20 && (group.current.position.z = -60),
  );
  return (
    <>
      {/* Ceiling */}
